...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.prompt2 = function (text, title, callbackOk, callbackCancel,text2,cantidad) {
            if (typeof title === 'function') {
                callbackCancel = arguments[2];
                callbackOk = arguments[1];
                title = undefined;
            ...
            return app.modal({
                text: text || '',
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                afterText: '<div class="input-field"><input type="number" class="modal-text-input" id="promptPrecio" value="' + text2 + '"></div></br><div class="input-field">Cantidad:<input type="number" id="promptcantidad" class="modal-text-input" value="' + cantidad + '"></div>',
                buttons: [
                    {
                        text: "Cancelar"
                    },
                ...
                onClick: function (modal, index) {
                    if (index === 0 && callbackCancel) callbackCancel($(modal).find('.modal-text-input').val());
                    if (index === 1 && callbackOk) callbackOk($(modal).find('#promptPrecio').val() + "-" + $(modal).find('#promptcantidad').val());
                }
            });
        };
                        ...
                        '{{else}}' +
                            ...
                            '<div class="item-inner">' +
                                '<div class="item-title-row">' +
                                    ...
                                    '{{/if}}' +
                                    '{{#if closeIcon}}' +
                                    '<div class="item-after"><a href="#" id="btnNotificacion" class="close-notification"><span></span></a></div>' +
                                    '{{/if}}' +
                                '</div>' +
                                '{{#if subtitle}}' +
